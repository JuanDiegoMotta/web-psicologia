    ...
    <main className="flex flex-col w-full min-h-screen bg-[#FFF5F3]/30">
      ...
      <section className="w-full pt-32 pb-16 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          <span className="text-pink-500 font-bold uppercase tracking-wider text-sm mb-4 block">Hablemos</span>
      ...
      <section className="w-full pb-24 px-6">
        <div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col lg:flex-row border border-pink-100">
          
          {/* Columna Izquierda: Información de Contacto */}
          <div className="w-full lg:w-2/5 bg-pink-50 p-10 md:p-14 flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-6">
                ...
                <a 
                  ...
                  className="flex items-center gap-4 bg-white p-4 rounded-2xl hover:shadow-md transition-shadow group"
                >
                  <div className="w-12 h-12 bg-pink-100 text-pink-600 rounded-xl flex items-center justify-center text-2xl group-hover:scale-110 transition-transform">
                    ✉️
                  </div>
                  <div>
            ...
            <form id="contact-form" action={handleFormAction} className="space-y-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <label htmlFor="privacy" className="text-sm text-gray-600 leading-relaxed">
                  He leído y acepto la <a href="#" className="text-pink-500 font-bold hover:underline">política de privacidad y protección de datos personales</a>.
                </label>
              </div>
