...
export default function SobreMiPage() {
  return (
    <main className="flex flex-col w-full">
      ...
      <section className="w-full pt-32 pb-20 px-6 bg-gradient-to-b from-salvia/40 to-white overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          <div className="w-full lg:w-5/12 text-center lg:text-left z-10">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-6 tracking-tight font-serif">
              ...
              <span className="text-eucalipto-dark">hay una persona.</span>
            </h1>
      ...
      <section className="relative w-full py-24 px-6 md:px-12 lg:px-20 overflow-hidden min-h-screen flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full text-left">
          ...
          <div className="md:w-1/2 lg:w-2/5 p-6 md:p-8 bg-white/60 rounded-3xl backdrop-blur-sm shadow-xl space-y-6 text-gray-600 md:text-lg leading-relaxed">
            ...
            <p>
              Soy <strong className="text-gray-800 font-semibold">Psicóloga Clínica</strong>, formada específicamente en trastornos emocionales y afectivos como la <span className="text-eucalipto-dark font-medium">ansiedad, depresión, duelo y trauma</span>. 
            </p>
            <p>
      ...
      <section className="w-full py-24 px-6 bg-arena/40">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Tarjeta 1: Sencillez */}
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-salvia/50 hover:-translate-y-1 transition-transform">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-salvia/50 hover:-translate-y-1 transition-transform">
              <div className="text-3xl mb-4">🐾</div>
              <p className="text-gray-600 leading-relaxed">
                Soy orgullosa <span className="font-semibold text-eucalipto-dark">Dog Mom</span> de Molly y Tariq. Ellos me recuerdan a diario la importancia del amor incondicional y de estar presente.
              </p>
            </div>
          </div>
      ...
      <section className="w-full py-24 px-6 text-center border-t border-gray-100 bg-gradient-to-b from-white to-salvia/40">
        <div className="max-w-3xl mx-auto flex flex-col items-center">
          <div className="w-16 h-16 bg-salvia rounded-full flex items-center justify-center text-2xl mb-6">
            🤝
          </div>
